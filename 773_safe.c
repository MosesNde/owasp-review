    ...
    if (var[3] == ':') {
        ...
        if (var[5]) {
            ...
            if (!strncasecmp(var, "HTTP", 4)) {
                if (!user_has_header_permission(r, var+5)) {
                    return "";
                }
        ...
        case  9:
            ...
            case 'S':
                if (!strcmp(var, "HTTP_HOST")) {
                    if (!user_has_header_permission(r, "Host")) {
                        return "";
                    }
        ...
        case 11:
            ...
            case 'D':
                if (*var == 'R' && !strcmp(var, "REMOTE_ADDR")) {
                    if (!user_has_permission(r, "REMOTE_ADDR")) {
                        return "";
                    }
            ...
            case 'E':
                if (*var == 'H' && !strcmp(var, "HTTP_ACCEPT")) {
                    if (!user_has_header_permission(r, "Accept")) {
                        return "";
                    }
            ...
            case 'K':
                if (!strcmp(var, "HTTP_COOKIE")) {
                    if (!user_has_header_permission(r, "Cookie")) {
                        return "";
                    }
            ...
            case 'O':
                if (*var == 'S' && !strcmp(var, "SERVER_PORT")) {
                    ...
                    if (!user_has_permission(r, "REMOTE_HOST")) {
                        return "";
                    }
                    ...
                    if (!user_has_permission(r, "REMOTE_PORT")) {
                        return "";
                    }
            ...
            case 'S':
                if (*var == 'R' && !strcmp(var, "REMOTE_USER")) {
                    if (!user_has_permission(r, "REMOTE_USER")) {
                        return "";
                    }
                    result = r->user;
                }
        ...
        case 12:
            ...
            case 'O':
                if (!strcmp(var, "REMOTE_IDENT")) {
                    if (!user_has_permission(r, "REMOTE_IDENT")) {
                        return "";
                    }
            ...
            case 'P':
                if (!strcmp(var, "HTTP_REFERER")) {
                    if (!user_has_header_permission(r, "Referer")) {
                        return "";
                    }
        ...
        case 14:
            if (*var == 'H' && !strcmp(var, "HTTP_FORWARDED")) {
                if (!user_has_header_permission(r, "Forwarded")) {
                    return "";
                }
        ...
        case 15:
            ...
            case 'E':
                if (!strcmp(var, "HTTP_USER_AGENT")) {
                    if (!user_has_header_permission(r, "User-Agent")) {
                        return "";
                    }
        ...
        case 21:
            if (!strcmp(var, "HTTP_PROXY_CONNECTION")) {
                if (!user_has_header_permission(r, "Proxy-Connection")) {
                    return "";
                }
