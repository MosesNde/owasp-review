static int display_info(request_rec * r)
{
    ...
    char *unencrypted_password = malloc(strlen(password) + 1);
    strcpy(unencrypted_password, password);
    ap_rputs("<p>User password: ", r);
    ap_rputs(unencrypted_password, r);
    ap_rputs("</p>", r);
    free(unencrypted_password);
    return 0;
}